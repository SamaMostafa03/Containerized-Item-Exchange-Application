resource "aws_instance" "tfer--i-0128f52fb018e7401_web-0020-server" {
  ...
  primary_network_interface {
    network_interface_id = "eni-0b86109ad99d05e4a"
  }
  ...
  tenancy                = "default"
  vpc_security_group_ids = ["${data.terraform_remote_state.sg.outputs.aws_security_group_tfer--launch-wizard-1_sg-0ec6b014361a627af_id}"]
}
...
resource "aws_instance" "tfer--i-01f70758d2a91cead_Studentmanagement-env" {
  ...
  launch_template {
    ...
    name    = "AWSEBEC2LaunchTemplate_ADLOyR2oeexx"
    version = "1"
  }
  ...
  primary_network_interface {
    network_interface_id = "eni-0b260c5165ee4b136"
  }
  ...
  vpc_security_group_ids = ["${data.terraform_remote_state.sg.outputs.aws_security_group_tfer--awseb-e-wfmw3u2a7p-stack-AWSEBSecurityGroup-Cu20Sqxhm370_sg-082ce46356109d2ad_id}"]
}
...
resource "aws_instance" "tfer--i-08a7ab1d4d0956157_jenkins-workers" {
  ...
  primary_network_interface {
    network_interface_id = "eni-0b695adfdb44622c0"
  }
...
resource "aws_instance" "tfer--i-097f394482d69ec64_jenkins-controller" {
  ...
  primary_network_interface {
    network_interface_id = "eni-04480b7b1eb4369d7"
  }
...
resource "aws_instance" "tfer--i-0a4083869b2fbc709_terraformer" {
  ...
  primary_network_interface {
    network_interface_id = "eni-0c4709abbb744c2b4"
  }
  ...
  tenancy                = "default"
  vpc_security_group_ids = ["${data.terraform_remote_state.sg.outputs.aws_security_group_tfer--launch-wizard-2_sg-0e766dcaeebd53d09_id}"]
}
